...
<body class="baseurlcls" data-baseurl="<?php echo base_url(); ?>">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="<?php echo site_url("dashboard"); ?>" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="<?php echo base_url("assets/images/logo-dark-sm.png"); ?>" alt="" height="26">
                            </span>
                            <span class="logo-lg">
                                <img src="<?php echo base_url("assets/images/logo-dark-sm.png"); ?>" alt="" height="26">
                            </span>
                        ...
                        <a href="<?php echo site_url("dashboard"); ?>" class="logo logo-light">
                            <span class="logo-lg">
                                <img src="<?php echo base_url("assets/images/logo-light.png"); ?>" alt="" height="30">
                            </span>
                            <span class="logo-sm">
                                <img src="<?php echo base_url("assets/images/logo-light-sm.png"); ?>" alt="" height="26">
                            </span>
                        </a>
                    </div>
                    ...
                    <div class="page-title-box align-self-center d-none d-md-block">
                        <h4 class="page-title mb-0">Product CMS</h4>
                    </div>
                    <!-- end page title -->
                </div>
                <div class="d-flex">
                    ...
                    <!-- <div class="dropdown d-inline-block language-switch ms-2">
                        <button type="button" class="btn header-item" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="header-lang-img" src="<?php echo base_url("assets/images/flags/us.jpg"); ?>" alt="Header Language" height="18">
                        </button>
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown-v"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="<?php echo base_url("assets/images/users/avatar-3.jpg"); ?>"
                            alt="Header Avatar">
                            <span class="d-none d-xl-inline-block ms-2 fw-medium font-size-15"><?php echo $loginData["login_full_name"]; ?></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            <div class="p-3 border-bottom">
                                <h6 class="mb-0"><?php echo $loginData["login_full_name"]; ?></h6>
                                <p class="mb-0 font-size-11 text-muted"><?php echo $loginData["login_email_address"]; ?></p>
                            </div>
                            ...
                            <a class="dropdown-item" href="<?php echo base_url(); ?>logout"><i class="mdi mdi-logout text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Logout</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="vertical-menu">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo site_url("dashboard"); ?>" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo base_url("assets/images/logo-dark.png"); ?>" alt="" height="28">
                    </span>
                </a>
                <a href="<?php echo site_url("dashboard"); ?>" class="logo logo-light">
                    <span class="logo-lg">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                                ...
                                <span class="menu-item" data-key="t-ecommerce">Master Detail</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="<?php echo base_url("master/category-list"); ?>" data-key="t-products">Category Master</a></li>
                                <li><a href="<?php echo base_url("master/component-list"); ?>" data-key="t-product-detail">Component Master</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="<?php echo base_url("product/new"); ?>" data-key="t-products">New Product</a></li>
                                <li><a href="<?php echo base_url("product/list"); ?>" data-key="t-product-detail">Product Listing</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="apps-calendar.html">
                                <i class="bx bx bx-user-pin icon nav-icon"></i>
                        ...
                        <li>
                            <a href="<?php echo base_url("logout"); ?>">
                                ...
                                <span class="menu-item" data-key="t-todo">Logout</span>
                            </a>
                        </li>                        
                    </ul>
                </div>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                        <a href="<?php echo site_url("dashboard"); ?>"  class="dropdown-item" data-key="t-ecommerce">Ecommerce</a>
